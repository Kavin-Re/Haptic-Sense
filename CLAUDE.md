...
**STATUS (2026-09-26): feature-complete and submission-ready** for TRON Programming Contest 2026 (Entry ID 34476); hardware shipped 21 Sep. The phase log below is kept as the engineering record and is intentionally not rewritten to match current status.
